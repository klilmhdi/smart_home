...
import 'package:smart_home/core/animations/fade_in_slide.dart';
import 'package:smart_home/core/common/app_colors.dart';
import 'package:smart_home/core/common/clippers.dart';
import 'package:smart_home/core/common/text_style_ext.dart';
import 'package:smart_home/features/oboarding/onboarding_data.dart';
import 'package:smart_home/core/router/app_routes.dart';
      ...
      body: Column(
        children: [
          ...
          Row(
            ...
            children: [
              ...List.generate(onboardingData.length,
                  (index) => Indicator(isActive: index == _pageIndex)),
            ],
          ),
        ...
        Padding(
          ...
          child: FadeInSlide(
            ...
            child: Text(
              ...
              textAlign: TextAlign.center,
              maxLines: 3,
              style: context.tm!.copyWith(height: 1.5, fontSize: 16.0),
            ),
          ),
        ),
        const Spacer(),
